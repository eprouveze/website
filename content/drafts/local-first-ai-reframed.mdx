...
![The AI sees numbers and patterns, but identities stay hidden behind a privacy boundary](/images/briefing-room-privacy.webp)
...
![Anonymization flow: identities become tokens, numbers pass through unchanged](/images/anonymization-flow-diagram.webp)
