...
![Defense-in-depth: three layers protecting the trusted forecast](/images/defense-in-depth-shields.webp)
...
![The ReAct loop: Reason, Select Tool, Execute, Observe, Decide—then either loop back or synthesize](/images/react-loop-diagram.webp)
