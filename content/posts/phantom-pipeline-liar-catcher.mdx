...
![Defense-in-depth: three layers protecting the trusted forecast from hallucinations, phantom pipeline, and invalid data](/images/defense-in-depth-shields.png)
