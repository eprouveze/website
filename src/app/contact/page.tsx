...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Get in touch with Emmanuel Prouvèze.',
}
    ...
    <section className="py-12 sm:py-16">
      <Container narrow>
        ...
        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
          I'm always interested in discussing AI, enterprise software, or opportunities
          in the technology space. The best way to reach me is through LinkedIn.
        </p>
